...
if __name__ == '__main__':
    ...
    arg(parser, 'learning_rate_d', type=float, default=0.0004, help='Discriminator learning rate')
    ...
    arg(parser, 'visualize_split', type=str, default='val', help='split to visualize with visualize_only')
